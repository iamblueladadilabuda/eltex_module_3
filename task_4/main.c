...
// Парсит одну подкоманду
void Parse_Command(char *cmd, char **argv, char **infile, char **outfile, int *append_out, int *append_in) 
{
    *infile = NULL;
    *outfile = NULL;
    *append_out = 0;
